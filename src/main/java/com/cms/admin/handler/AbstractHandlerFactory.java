...
/**
 * @author greatli @ClassName AbstractoryHandlerFatory.java @Description TODO
...
public class AbstractHandlerFactory {
  ...
  public void init() {
    handlerMap.put(
        Constant.VIDEO_HANDLER_NAME.getValue(), applicationContext.getBean(VideoHandler.class));
    handlerMap.put(
        Constant.TEXT_HANDLER_NAME.getValue(), applicationContext.getBean(TextHandler.class));
    handlerMap.put(
        Constant.IMAGE_HANDLER_NAME.getValue(), applicationContext.getBean(ImageHandler.class));
  }
}
