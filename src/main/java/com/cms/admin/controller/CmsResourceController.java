...
public class CmsResourceController {
  ...
  @Resource AbstractHandlerFactory factory;
  ...
  private ResponseEntity<Object> saveResource(
      @RequestParam("file") MultipartFile file, @PathVariable("fileType") String fileType) {
