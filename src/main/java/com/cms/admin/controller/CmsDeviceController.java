...
public class CmsDeviceController {
    @Resource
    private CmsDeviceService deviceService;

    @ApiOperation("设备列表-分页查询")
    @GetMapping("/{page}/{size}")
    public ResponseEntity<Object> getAllDevice(@PathVariable("page") Integer page, @PathVariable("size") Integer size) {
    ...
    public ResponseEntity<Object> selectDeviceById(@PathVariable("id") Integer id, @PathVariable("page") Integer page, @PathVariable("size") Integer size) {
    ...
    public ResponseEntity<Object> selectDeviceByIp(@PathVariable("ip") String ip, @PathVariable("page") Integer page, @PathVariable("size") Integer size) {
    ...
    public ResponseEntity<Object> selectDeviceByMac(@PathVariable("mac") String mac, @PathVariable("page") Integer page, @PathVariable("size") Integer size) {
